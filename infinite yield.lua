...
Title.TextSize = 18
Title.Text = "Infinite Yield Remaster v" .. currentVersion
...
Cmdbar.Text = ""
Cmdbar.ZIndex = 10
Cmdbar.PlaceholderText = "Comando barra"
...
CMDs[#CMDs + 1] = {NAME = 'bola', DESC = 'vire uma bola(reseta para tirar), comando add by kelvin'}
CMDs[#CMDs + 1] = {NAME = 'unbola', DESC = 'tirar o comando de bola, by Kelvin'}
...
addcmd('bola',{},function(args, speaker)
-- bola
